...
public class PullToRefreshListViewCustom extends PullToRefreshListView{
    ...
    public void setQuickReturnListViewOnScrollListener(QuickReturnType quickReturnType, View headerView, int headerTranslation, View footerView, int footerTranslation){
	...
	public PullToRefreshListViewCustom(Context context, AttributeSet attrs) {
		super(context, attrs);
