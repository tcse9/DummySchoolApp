...
public class PagerSlidingTabStripGoodRead extends HorizontalScrollView {
	...
	// private ViewPager anotherPager;

	PagerSlidingTabStripGoodRead anotherTabStrip;

	public void setPagerWeightToOne() {
		this.defaultTabLayoutParams.weight = 1;
	}

	public PagerSlidingTabStripGoodRead(Context context) {
		this(context, null);
	}

	public PagerSlidingTabStripGoodRead(Context context, AttributeSet attrs) {
	...
	public PagerSlidingTabStripGoodRead(Context context, AttributeSet attrs,
		...
		// defaultTabLayoutParams.setMargins(20, 0, 20, 0);
	...
	public void setViewPager(ViewPager pager,
			PagerSlidingTabStripGoodRead anotherTabStrip) {
		this.pager = pager;
		// this.anotherPager = anotherPager;
		this.anotherTabStrip = anotherTabStrip;
	...
	public void notifyDataSetChanged() {
		...
		for (int i = 0; i < tabCount; i++) {
			...
			if (pager.getAdapter() instanceof IconTabProvider) {
				...
				addTextTab(i, ((TextTabProvider) pager.getAdapter())
						.getPageText(i).toString());
			}
		}
	...
	private void addTextTab(final int position, String title,String folderId) {
	...
	private void addTab(final int position, final View tab) {
		...
		tab.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				for (int i = 0; i < anotherTabStrip.tabCount; i++) {
					View view = anotherTabStrip.tabsContainer.getChildAt(i);
					view.setBackgroundResource(tabBackgroundResId);
				}

				// tab.setBackgroundResource(R.drawable.select);
				// ((ImageButton)tab).setImageResource(resId)
				anotherTabStrip.pager.setVisibility(View.GONE);
				pager.setVisibility(View.VISIBLE);
				pager.bringToFront();

				Log.e("pager position", position + "");

				PagerSlidingTabStripGoodRead.this.context
	...
	protected void onDraw(Canvas canvas) {
		...
		// currentTab.setBackgroundResource(R.drawable.select);
		//
		//
		// for (int i = 0; i < tabCount; i++) {
		//
		...
		// ImageView selectedBg = new ImageView(getContext());
